...
// line 57 "../../../../../BikeTourPlusAdditionalTransferObjects.ump"
// line 4 "../../../../../BikeTourPlusTransferObjects.ump"
public class TOBikeTour
{
  ...
  @Override
  // line 60 "../../../../../BikeTourPlusAdditionalTransferObjects.ump"
   public String toString(){
    return ("ID " + Integer.toString(id) + " : weeks " + Integer.toString(startWeek) + " - " + Integer.toString(endWeek));
  }
